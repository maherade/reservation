...
class AdultCounterRow extends StatefulWidget {
  int counter;
  Color counterColor;
  AdultCounterRow({required this.counterColor, required this.counter,super.key});

  @override
  State<AdultCounterRow> createState() => _CounterRowState();
}

class _CounterRowState extends State<AdultCounterRow> {
